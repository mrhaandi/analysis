...
- in file `ereal.v`:
  ...
  + lemmas `fsume_ge0`, `fsume_le0`, `fsume_gt0`, `fsume_lt0`, `pfsume_eq0`
    `ge0_mule_fsumr`, `ge0_mule_fsuml` (from `fsbigop.v`)
  + lemmas `finite_supportNe`, `dual_fsumeE`, `dfsume_ge0`, `dfsumee_le0`,
...
- in file `classical/set_interval.v`:
  ...
  + lemmas `setNK`, `lb_ubN`, `ub_lbN`, `has_lb_ubN`, `has_ubPn`, `has_lbPn` (from `reals.v`)
- in file `classical/mathcomp_extra.v`:
...
- in file `fsbigop.v`:
  ...
  + lemma `ge0_mule_fsumr`, `ge0_mule_fsuml`, `fsume_ge0`, `fsume_le0`,
...
- in file `reals.v`:
  + lemmas `setNK`, `lb_ubN`, `ub_lbN`, `has_lb_ubN`, `has_ubPn`, `has_lbPn`
