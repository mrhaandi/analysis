...
(* a known interval sign easier, thanks to canonical structures. This adds    *)
(* types like {itv R & a, b]}, a notation e%:itv that infers an enclosing     *)
(* interval for expression e according to existing canonical instances and    *)
(* %:inum to cast back from type {itv R & i} to R.                            *)
(* For instance, x : {iO1 R}, we have (1 - x%:inum)%:itv : {i01 R}            *)
...
Module Exports.
Notation "{ 'itv' R & i }" := (def R i) : type_scope.
